...
import { AlertCircle, Globe, Loader2, UserCircle2 } from "lucide-react";
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sidebar-foreground/60 text-sm">
            My Web Solutions — Client Portal
          </p>
        </div>
          ...
          <CardContent className="p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <Input
                  id="client-username"
                  data-ocid="client_login.username_input"
                  placeholder="yourclientid"
                  value={username}
              ...
              <div>
                ...
                <Input
                  id="client-password"
                  data-ocid="client_login.password_input"
                  type="password"
                  placeholder="••••••••"
                  value={password}
              ...
              <Button
                type="submit"
                data-ocid="client_login.submit_button"
